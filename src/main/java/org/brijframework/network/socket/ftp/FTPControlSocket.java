...
public class FTPControlSocket {
   ...
   */
  public FTPControlSocket(String remoteHost, int controlPort) throws
   ...
   */
  public FTPControlSocket(InetAddress remoteAddr) throws IOException,
      FTPException {
   ...
   *   @param   controlPort  port for control stream
   */
  public FTPControlSocket(InetAddress remoteAddr, int controlPort) throws
      IOException, FTPException {
   ...
   */
  FTPDataSocket createDataSocket(FTPConnectMode connectMode) throws
      IOException, FTPException {
   ...
   */
  private void setDataPort(InetAddress host, short portNo) throws IOException,
      FTPException {
   ...
   *
   */
  void validateReply(String reply, String expectedReplyCode) throws
      IOException, FTPException {
   ...
   *
   */
  void validateReply(String reply, String[] expectedReplyCodes) throws
      IOException, FTPException {
